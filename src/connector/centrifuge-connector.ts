...
import { CentrifugePrivateChannel, CentrifugePresenceChannel, CentrifugeChannel } from '../channel';
...
export class CentrifugeConnector extends Connector {
    ...
    channel(name: string): CentrifugeChannel {
        if (!this.channels[name]) {
            this.channels[name] = new CentrifugePrivateChannel(this.centrifuge, name, this.options);
        }
